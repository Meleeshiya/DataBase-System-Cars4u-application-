...
wwv_flow_api.set_version(p_version_yyyy_mm_dd=>'2021.04.15');
...
begin
   ...
   wwv_flow_hint.g_schema   := 'C7296152';
...
--------------------------------------------------------------------
prompt  SCHEMA C7296152 - User Interface Defaults, Table Defaults
--
-- Import using sqlplus as the Oracle user: APEX_210100
-- Exported 11:45 Saturday May 14, 2022 by: C7296152
--
commit;
begin 
